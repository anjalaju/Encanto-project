      ...
      body: Consumer<FunctionProvider>(
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject('4star &abouve hotels','Venues').asStream(),
              builder: (context, snapshot) {
                final listproject = instance.listevent;
                return listproject.isEmpty?Center(child: Text('No 4 star hotel find'),):  SingleChildScrollView(
                    child: Column(
                  children: [
                    TextField(
